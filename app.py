"""Streamlit UI — Vitis AI Porting Advisor · Neo-Tactile dark theme."""
import asyncio
import json
import os
import sys
...
if not run_btn:
    ...
    <div class="neo-card" style="text-align:center;padding:2.5rem 2rem;">
      ...
      <div style="font-size:0.82rem;color:rgba(100,116,139,0.8);max-width:360px;margin:0 auto;">
        Upload a <code>.onnx</code> or <code>.pt</code> model file, enter your Anthropic API key,
        select a target DPU architecture, then hit <strong>Run Pipeline</strong>.
      </div>
    </div>
    """, unsafe_allow_html=True)
